#!/usr/bin/env python
####################################################################################
# The ROS-Node which provides a (fake) camera calibration
####################################################################################
"""
...
yamlPath = rospack.get_path('searchwing') + "/config/fakeGoProCalib.yaml"
print(yamlPath)
# Parse yaml file
camera_info_msg = yaml_to_CameraInfo(yamlPath)

# Initialize publisher node
rospy.init_node("camera_info_publisher", anonymous=True)
publisher = rospy.Publisher("gopro/camera_info", CameraInfo, queue_size=10)
rate = rospy.Rate(0.5)
