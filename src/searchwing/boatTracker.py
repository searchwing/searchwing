...
class boatTracker():
    ...
    def addDetections(self,detections):
        ...
        if len(self.tracks)==0:
            ...
            """
            euclidDist = d1-t1 d1-t2 d1-t3 d1-t4...
            ...
            """
                    ...
                    => col_ind = zugewiesen => welches tracking wird welcher detektion zugewiesen
            """
            for oneRow_ind in row_ind:
                ...
                if assignedEuclidDist < associationTresh:
                    ...
                    self.tracks[assignedTrackIdx].setPos(currentDetection)
